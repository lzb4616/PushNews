...
import com.pushnews.app.adapter.holder.ChannelListViewHolder;
...
public class ChannelListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		ChannelListViewHolder holder = null;		
		if (convertView == null) {
			holder = new ChannelListViewHolder();
			convertView = mInflater.inflate(
					R.layout.channel_manger_listitem, null);
			holder.channelListTv = (TextView) convertView
					.findViewById(R.id.cmlt_item);
			convertView.setTag(holder);
			newsContent = channelList.get(position).getNewsContent();
			holder.channelListTv.setText(newsContent);
		} else {
			holder = (ChannelListViewHolder) convertView.getTag();
		}
