...
import com.pushnews.app.https.ImageLoaderUntil;
...
public class NewListAdapter extends BaseAdapter implements Filterable {
	...
	/**加载图片类*/
	private ImageLoaderUntil ImageLoaderUntil;
	...
	public NewListAdapter(Context context, List<? extends Map<String, ?>> data,
		...
		ImageLoaderUntil = new ImageLoaderUntil(context);
	}
...
if (url!=null&&!url.equals("")) {
	new AsyncTask<String, Void, Bitmap>() {
		...
		protected Bitmap doInBackground(String... params) {
			return	ImageLoaderUntil.imageLoad(params[0], news_id);
		}
		@Override
